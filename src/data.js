export const projects = [
  ...
  },
  {
    ...
    subtitle: "React.js",
    description:
      "The React to-do list application is a user-friendly web interface that allows users to create, manage, and organize tasks in a visually intuitive manner. It offers features like task creation, deletion, and completion, providing a streamlined and efficient way to keep track of daily responsibilities.",
    link: "https://github.com/amideo5/react-to-do-list",
  },
  {
    title: "Doctor Appointment Backend",
    subtitle: "Spring Boot",
    description:
      "The Doctor Appointment Spring Boot backend is a Java-based web application framework that handles the backend operations of scheduling and managing medical appointments. It utilizes the Spring ecosystem to efficiently manage data, authentication, and API endpoints, ensuring a seamless and secure process for both patients and healthcare providers.",
...
export const education = [
  ...
  },
  {
    ...
    company: "Dr. Virendra Swarup Education Center, Kanpur",
  },
  {
    quote: "CGPA : 9.6",
